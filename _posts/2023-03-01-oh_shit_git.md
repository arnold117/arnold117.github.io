...
用好 Git 很难: 很容易就犯错了，然后想自己弥补犯下的错，简直太难了。查阅 Git 文档简直就像是个 “鸡生蛋 蛋生鸡” 的问题，_你得知道你要的是啥_ ，但问题就在于我不知道呀！

所以接下来我会分享一些我遇到过的抓狂的经历，然后用 _白话_ 来说说我是如何解决的。
...
_警告: 你千万不要在已推送的公共分支上做这个 amend 的操作! 只能在你本地 commit 上做这种修改，否则你会把事情搞砸的！_
